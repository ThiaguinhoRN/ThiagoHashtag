...
for (const produtoCatalogo of catalogo) {
    const cartaoProduto = `<div class= "border-solid border-2 shadow-xl shadow-slate-400 rounded-lg w-48 m-2 flex flex-col justify-between p-2 group ${produtoCatalogo.feminino ? "feminino" : "masculino"}" id="card-produto-${produtoCatalogo.id}">
    <img 
